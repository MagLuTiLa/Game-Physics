...
//caller already does the filter on the m_closestHitFraction
	...
	struct	ContactResultCallback
	{
		...
		virtual	btScalar	addSingleResult(btManifoldPoint& cp,	btCollisionObjectWrapper* colObj0Wrap,int partId0,int index0,btCollisionObjectWrapper* colObj1Wrap,int partId1,int index1) = 0;
	};
