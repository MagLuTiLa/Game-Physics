...
static bool btAdjustInternalEdgeContactsCallback(btManifoldPoint& cp,	btCollisionObject* colObj0,int partId0,int index0,btCollisionObject* colObj1,int partId1,int index1)
{
