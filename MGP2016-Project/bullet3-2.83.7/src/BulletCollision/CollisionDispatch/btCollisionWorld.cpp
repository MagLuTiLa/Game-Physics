		...
		if (collisionShape->isConcave())
		{
			...
			//ConvexCast::CastResult
				struct BridgeTriangleRaycastCallback : public btTriangleRaycastCallback
				{
					...
					btCollisionWorld::RayResultCallback* resultCallback, btCollisionObject* collisionObject,const btConcaveShape*	triangleMesh,const btTransform& colObjWorldTransform):
						//@BP Mod
...
struct btBridgedManifoldResult : public btManifoldResult
{
	...
	btBridgedManifoldResult( btCollisionObjectWrapper* obj0Wrap,btCollisionObjectWrapper* obj1Wrap,btCollisionWorld::ContactResultCallback& resultCallback )
