...
void	btAdjustInternalEdgeContacts(btManifoldPoint& cp, btCollisionObjectWrapper* trimeshColObj0Wrap,btCollisionObjectWrapper* otherColObj1Wrap, int partId0, int index0, int normalAdjustFlags = 0);
