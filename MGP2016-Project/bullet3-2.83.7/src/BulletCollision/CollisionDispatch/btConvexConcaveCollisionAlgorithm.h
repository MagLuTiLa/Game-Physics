...
int	m_triangleCount;
	...
	void	setTimeStepAndCounters(btScalar collisionMarginTriangle,const btDispatcherInfo& dispatchInfo,btCollisionObjectWrapper* convexBodyWrap, btCollisionObjectWrapper* triBodyWrap, btManifoldResult* resultOut);
...
public:
	...
	btConvexConcaveCollisionAlgorithm( const btCollisionAlgorithmConstructionInfo& ci,btCollisionObjectWrapper* body0Wrap,btCollisionObjectWrapper* body1Wrap,bool isSwapped);
