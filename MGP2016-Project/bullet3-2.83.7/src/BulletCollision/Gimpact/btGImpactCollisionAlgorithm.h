...
protected:
	...
	SIMD_FORCE_INLINE void checkManifold(btCollisionObjectWrapper* body0Wrap,btCollisionObjectWrapper* body1Wrap)
	{
	...
	// Call before process collision
	SIMD_FORCE_INLINE btCollisionAlgorithm * newAlgorithm(btCollisionObjectWrapper* body0Wrap,btCollisionObjectWrapper* body1Wrap)
	{
	...
	// Call before process collision
	SIMD_FORCE_INLINE void checkConvexAlgorithm(btCollisionObjectWrapper* body0Wrap,btCollisionObjectWrapper* body1Wrap)
	{
...
public:
	...
	btGImpactCollisionAlgorithm( const btCollisionAlgorithmConstructionInfo& ci,btCollisionObjectWrapper* body0Wrap,btCollisionObjectWrapper* body1Wrap);

	virtual ~btGImpactCollisionAlgorithm();

	virtual void processCollision (btCollisionObjectWrapper* body0Wrap,btCollisionObjectWrapper* body1Wrap,const btDispatcherInfo& dispatchInfo,btManifoldResult* resultOut);
